...
class CriticalEffect_Incendiary(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_Incendiary_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_EngineDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_EngineDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_EngineDestroyed(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_EngineDestroyed_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_AmmoExplosion(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_AmmoExplosion_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_FuelExplosion(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_FuelExplosion_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_CompReset(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_CompReset_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_BailedOut(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_BailedOut_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_ArmourCracked(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_ArmourCracked_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_Spalling(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_Spalling_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_TracksBroken(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_TracksBroken_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_TurretStuck(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_TurretStuck_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_HUD(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_HUD_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_CrewInjured(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_CrewInjured_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_MainRotorDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_MainRotorDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_Turbine_Engine_Failure(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_Turbine_Engine_Failure_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_turbineOnFire(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_turbineOnFire_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_FuelTankOnFire(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_FuelTankOnFire_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_FuelTankLeaking(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_FuelTankLeaking_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_WeaponsJammed(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_WeaponsJammed_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_Hydraulic_Fluid_Fire(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_Hydraulic_Fluid_Fire_Desc", Roll=Roll)
        self.Roll = Roll


class HelicoCriticalEffect_TailRotorDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/HelicoCriticalEffect_TailRotorDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_WingsDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_WingsDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_EngineOnFire(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_EngineOnFire_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_PropellerDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_PropellerDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_EngineDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_EngineDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_FloatCarburatorFailure(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_FloatCarburatorFailure_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_OilLeak(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_OilLeak_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_EngineOverheating(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_EngineOverheating_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_EngineStalling(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_EngineStalling_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_ElevatorDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_ElevatorDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_FuelTankLeaking(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_FuelTankLeaking_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_RadiatorDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_RadiatorDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_RadiatorOverheating(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_RadiatorOverheating_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_PilotInjured(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_PilotInjured_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_PilotPanicked(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_PilotPanicked_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_PilotUnconscious(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_PilotUnconscious_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_WeaponsJammed(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_WeaponsJammed_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_AileronDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_AileronDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_TailDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_TailDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_FuelTankOnFire(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_FuelTankOnFire_Desc", Roll=Roll)
        self.Roll = Roll


class AirplaneCriticalEffect_RudderDamaged(TCriticalEffect):
    def __init__(self, Roll=[type: 4, value: None}, type: 4, value: None}]):
        super().__init__(Descriptor="GFX/UnitConstantes/AirplaneCriticalEffect_RudderDamaged_Desc", Roll=Roll)
        self.Roll = Roll
...
class TemplateCriticalEffectModule_GroundUnit(TCriticalEffectModuleDescriptor):
    def __init__(self, PackEffetCritique="PackEffetCritique_HelicoArme", EffectsFromTerrain=[]):
        super().__init__(RicochetEffectsOnTop=[], RicochetEffectsOnRear=[], RicochetEffectsOnSides=[], RicochetEffectsOnFront=[], PierceEffectsOnTop=[], PierceEffectsOnRear=PackEffetCritique, PierceEffectsOnSides=PackEffetCritique, PierceEffectsOnFront=PackEffetCritique, EffectsOnTop=PackEffetCritique, EffectsOnRear=PackEffetCritique, EffectsOnSides=PackEffetCritique, EffectsOnFront=PackEffetCritique, EffectsFromTerrain=EffectsFromTerrain, TerrainCriticalEffectTimer=1, Bounds=[1, 200])
...
class DistrictDescriptor(TEntityDescriptor):
    def __init__(self, KillWhenDamagesReachMax=True, MaxPhysicalDamages=15, NbSlots=4, ClassNameForDebug="Small_District", CadavreDescriptorId="GUID:{8ba7a9ce-1db8-4d75-8420-c43e92fa6ef3}", DescriptorId="GUID:{b48192ea-4d1e-491b-a8a6-cb1244251f58}"):
        super().__init__(ModulesDescriptors=[TTypeUnitModuleDescriptor(TypeUnitFormation=None, AcknowUnitType=None, MotherCountry=None, Coalition=None), "GFX/Unit/DistrictTagsModuleDescriptor", "GFX/Unit/DistrictFlagsModuleDescriptor", "GFX/Unit/DistrictModuleDescriptor", TDistrictUnitsContainerModuleDescriptor(AllowedTagSet=["Inf_quartier_ok"], NbSlots=NbSlots), TDynamicTerrainModuleDescriptor(TerrainToApplyOnDeath="ETerrainType/Ruin", TerrainToApplyOnInit="ETerrainType/Batiment"), "GFX/Unit/InflammableModuleDescriptorDistrict", "GFX/Unit/DistrictPositionModuleDescriptor", TBaseDamageModuleDescriptor(StunDamageLevelsPack=None, SuppressDamageLevelsPack=None, PhysicalDamageLevelsPack=None, MaxStunDamages="GFX/Unit/Building_MaxStunDamages", MaxSuppressionDamages="GFX/Unit/Building_MaxSuppressionDamages", MaxPhysicalDamages=MaxPhysicalDamages), TDamageModuleDescriptor(UseTopArmorAgainstFire=True, AutoOrientation=False, HitRollECM=0.0, KillWhenDamagesReachMax=KillWhenDamagesReachMax, BlindageProperties=TBlindageProperties(ExplosiveReactiveArmor=False, ResistanceTop=TResistanceTypeRTTI(Index=1, Family="ResistanceFamily_batiment"), ResistanceRear=TResistanceTypeRTTI(Index=1, Family="ResistanceFamily_batiment"), ResistanceSides=TResistanceTypeRTTI(Index=1, Family="ResistanceFamily_batiment"), ResistanceFront=TResistanceTypeRTTI(Index=1, Family="ResistanceFamily_batiment")), StunDamagesRegen="GFX/Unit/Building_StunDamagesRegen", SuppressDamagesRegenRatio="GFX/Unit/Building_SuppressDamagesRegenRatioList"), "GFX/Unit/DistrictSelectionModuleDescriptor", TShootingPointsModuleDescriptor(), "GFX/Unit/DistrictApparenceModuleDescriptor", "GFX/Unit/LinkTeamModuleDescriptor", "GFX/Unit/DebugModuleDescriptor", TIAStratModuleDescriptor(GameplayBehavior="EGameplayBehavior/Nothing", DatabaseId=1), TCadavreGeneratorModuleDescriptor(CadavreDescriptor="CadavreDescriptor"), TMinimapDisplayModuleDescriptor(FollowUnitOrientation=True, Texture="Texture_Minimap_Unit_inf"), "GFX/Unit/PackSignauxModuleDescriptor", "GFX/Unit/TargetDataModuleDescriptor"], ClassNameForDebug=ClassNameForDebug, DescriptorId=DescriptorId, CadavreDescriptor=TEntityDescriptor(ModulesDescriptors=[TTypeUnitModuleDescriptor(TypeUnitFormation=None, AcknowUnitType=None, MotherCountry=None, Coalition=None), "GFX/Unit/DistrictTagsModuleDescriptor", "GFX/Unit/DistrictFlagsModuleDescriptor", "GFX/Unit/DistrictCadavrePositionModuleDescriptor", "GFX/Unit/LinkTeamModuleDescriptor", "GFX/Unit/DebugModuleDescriptor", TIAStratModuleDescriptor(GameplayBehavior="EGameplayBehavior/Nothing", DatabaseId=1), BuildingCadavreModuleDescriptor(ModuleDescriptorsToSteal=["GFX/Unit/DistrictApparenceModuleDescriptor"], CadavreDuration="GFX/Unit/CadavreDurationApresFeu_Batiment"), "GFX/Unit/DistrictApparenceModuleDescriptor"], ClassNameForDebug=None, DescriptorId=CadavreDescriptorId, World=None, CadavreDescriptor=None))
        self.KillWhenDamagesReachMax = KillWhenDamagesReachMax
        self.MaxPhysicalDamages = MaxPhysicalDamages
        self.NbSlots = NbSlots
        self.ClassNameForDebug = ClassNameForDebug
...
class CriticalEffect_TransmissionDamaged(TCriticalEffect):
    def __init__(self, Roll=None):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_TransmissionDamaged_Desc", Roll=Roll)
        self.Roll = Roll


class CriticalEffect_Bounce(TCriticalEffect):
    def __init__(self, Roll=None):
        super().__init__(Descriptor="GFX/UnitConstantes/CriticalEffect_Bounce_Desc", Roll=Roll)
        self.Roll = Roll
