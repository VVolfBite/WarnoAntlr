...
class TEntityDescriptor(BaseDescription):
    def __init__(self, ModulesDescriptors=None, DescriptorId=None, ClassNameForDebug=None, World=None):
...
class DistrictDescriptor(BaseDescription):
    def __init__(self, DescriptorId=None, CadavreDescriptorId=None, ClassNameForDebug=None, NbSlots=None, MaxPhysicalDamages=None, KillWhenDamagesReachMax=None):
        self.DescriptorId = DescriptorId
...
class CriticalEffect_TransmissionDamaged(TCriticalEffect):
    def __init__(self, Roll=None):
        super().__init__(Descriptor=TCriticalEffectDescriptor(DisplayOnDeath=False, Unique=True, RepairCost=50, TimeOut=-1, EffectsPack="$/GFX/EffectCapacity/UnitEffect_Critic_Vitesse_50", HappeningKey="critical_engine_damaged", Token="CRITIC6"), Roll=Roll)
        self.Roll = Roll


class CriticalEffect_Bounce(TCriticalEffect):
    def __init__(self, Roll=None):
        super().__init__(Descriptor=TCriticalEffectDescriptor(DisplayOnDeath=False, Unique=False, RepairCost=-1, TimeOut=0, EffectsPack=None, HappeningKey=None, Token="BOUNCE1"), Roll=Roll)
        self.Roll = Roll
